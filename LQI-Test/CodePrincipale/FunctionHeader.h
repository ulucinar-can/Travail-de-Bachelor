 ...
 * Modified by: Laucella (2019), Yersin (2022), Freyche (2025), Ulu�inar (2026)
 *
...
#define L_N1            ((float)7.742e-3)       // Inductance nominal au point nominal pour l'inducteur 1 (prise � 120 Hz)
#define L_N2            ((float)8.647e-3)       // Inductance nominal au point nominal pour l'inducteur 2 (prise � 120 Hz)
#define L_N3            ((float)7.699e-3)       // Inductance nominal au point nominal pour l'inducteur 3 (prise � 120 Hz)
#define L_N4            ((float)7.750e-3)       // Inductance nominal au point nominal pour l'inducteur 4 (prise � 120 Hz)
...
#define KP_I            2.0f // Avec Kui � -45� : Kpi = 90.964f et sans kui : Kpi = 1.88
