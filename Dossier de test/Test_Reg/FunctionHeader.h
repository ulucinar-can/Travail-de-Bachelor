...
#define KP_I1           2.0f // Avec Kui ï¿½ -45ï¿½ : Kpi = 90.964f et sans kui : Kpi = 1.88
#define KP_I2           2.0f // Avec Kui ï¿½ -45ï¿½ : Kpi = 90.964f et sans kui : Kpi = 1.88
#define KP_I3           2.0f // Avec Kui ï¿½ -45ï¿½ : Kpi = 90.964f et sans kui : Kpi = 1.88
#define KP_I4           2.0f // Avec Kui ï¿½ -45ï¿½ : Kpi = 90.964f et sans kui : Kpi = 1.88
...
#define KW1               ((float)-1.4862e4)
#define KDDOT1            -603.41f
#define KD1               ((float)-3.8998e4)
#define KR1               -35.63f
...
#define KW2               ((float)-1.4862e4)
#define KDDOT2            -603.41f
#define KD2               ((float)-3.8998e4)
#define KR2               -35.63f
...
// --- State method regulation for inductor 3 ---
...
#define KW4               ((float)-1.4862e4)
#define KDDOT             -603.41f
#define KD4               ((float)-3.8998e4)
#define KR4               -35.63f
